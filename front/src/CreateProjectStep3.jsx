    ...
    try {
      const res = await fetch(`${API_URL}/api/campaigns`, {
        ...
        body: JSON.stringify({
          ...
          target_amount: 1000, // Default 1 TND (1000 millimes) — user will update in editor
        }),
      });
      ...
      // Save the campaign ID to the draft for later use
      if (onSaveDraft) onSaveDraft({ campaignId: data.campaign_id });
  ...
  return (
    <div className="cp-wrapper">
      ...
      <footer className="cp-footer">
        ...
        >
          {loading ? 'Création en cours...' : 'Valider mon projet'}
        </button>
      </footer>
