        ...
        {!isAuthenticated ? (
          ...
          <div className="user-profile-container" ref={menuRef}>
            <div 
              ...
              style={{ width: '36px', height: '36px', borderRadius: '50%', background: storedUser.avatar ? 'none' : 'linear-gradient(135deg, #0ce688, #0ab56b)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '14px', fontWeight: '800', color: '#0b0f19', cursor: 'pointer', overflow: 'hidden' }}
            >
              {storedUser.avatar ? (
